...
public class AppInfo {
	...
	public AppInfo(long id, String name, String packageName, String iconUrl, float stars, long size, String downloadUrl,
			String describe, String downloadNum, String version, String date, String author, List<String> screen,
	...
	public String toString() {
		return "AppInfo [id=" + id + ", name=" + name + ", packageName=" + packageName + ", iconUrl=" + iconUrl
				+ ", stars=" + stars + ", size=" + size + ", downloadUrl=" + downloadUrl + ", describe=" + describe
				+ ", downloadNum=" + downloadNum + ", version=" + version + ", date=" + date + ", author=" + author
				+ ", screen=" + screen + ", safeUrl=" + safeUrl + ", safeDesUrl=" + safeDesUrl + ", safeDes=" + safeDes
